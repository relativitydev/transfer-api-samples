> **NOTE**: Relativity.Transfer.Client version 7.4.10 (and below) **will stop functioning on Q2 2023** (we will communicate the precise date 3 months before) due to migration of data transfer related products to cloud based solutions. 
